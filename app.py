...
st.markdown(f"""
    ...
    .stApp {{max-width: 650px; margin: auto; background: white; border-radius: 25px; padding: 2rem; box-shadow: 0 15px 40px rgba(255,193,7,0.3); border: 3px solid #FFC107;}}
    
    .logo-container {{text-align: center; margin-bottom: 15px;}}
    .logo-container img {{border-radius: 50%; border: 4px solid #FFC107; width: 120px; height: 120px; object-fit: cover;}}
